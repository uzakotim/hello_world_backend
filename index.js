...
app.listen(port, () => {
  console.log(`Tomatoes API server is running on http://localhost:${port}`);
  console.log('Available endpoints:');
  console.log('  GET    /              - API information');
  console.log('  GET    /health        - Health check');
  console.log('  GET    /tomatoes      - Get all tomatoes');
  console.log('  POST   /tomatoes      - Create a tomato');
  console.log('  GET    /tomatoes/:id  - Get a tomato');
  console.log('  PUT    /tomatoes/:id  - Update a tomato');
  console.log('  DELETE /tomatoes/:id  - Delete a tomato');
});
